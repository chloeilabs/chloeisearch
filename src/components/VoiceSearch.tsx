 ...
 * The divider before the mic lives here (not in SearchBox) so it never
 * dangles in browsers without speech recognition.
 */
  ...
  return (
    <>
      ...
      <button
        ...
        className={`shrink-0 rounded-full p-1 ${listening ? 'animate-pulse bg-[#fce8e6] dark:bg-[#5c2b29]' : 'hover:bg-card'}`}
      >
